...
export function setup({navigation}){
  ...
  const validateStep = () => {
    ...
    if (currentStep === 1) {
      ...
      if (!userData.email.includes("@")) errors.email = "Enter a valid email";
      ...
      <View style={styles.reviewContainer}>
        ...
        <View style={styles.reviewSection}>
          ...
          <View style={styles.reviewItem}>
            ...
            <Text style={styles.reviewValue}>{userData.weight} kg</Text>
          </View>
          <View style={styles.reviewItem}>
        ...
        <View style={styles.reviewSection}>
          ...
          <View style={styles.reviewItem}>
            ...
            <Text style={styles.reviewValue}>{userData.availableMess}</Text>
          </View>
        </View>
      </View>
